---
title: "Polio Mutations (Distance Corrected Serotypes) 5UTR only"
author: "Philip Tzou"
date: "2023-09-28"
...
s1NAPairs = extractNAPairs(s1Alignments) %>% filter(pos < 1001)
s2NAPairs = extractNAPairs(s2Alignments) %>% filter(pos < 1001)
s3NAPairs = extractNAPairs(s3Alignments) %>% filter(pos < 1001)
```
